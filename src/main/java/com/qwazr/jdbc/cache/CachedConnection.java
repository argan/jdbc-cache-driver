...
class CachedConnection implements Connection {
	...
	public PreparedStatement prepareStatement(final String sql) throws SQLException {
		...
		return resultSetCache != null && resultSetCache.acceptQuery(sql) ? new CachedPreparedStatement<>(this, resultSetCache, statement, sql) : statement;
	}

	@Override
	public CallableStatement prepareCall(String sql) throws SQLException {
		final CallableStatement statement = connection == null ? null : connection.prepareCall(sql);
		return resultSetCache != null && resultSetCache.acceptQuery(sql) ? new CachedCallableStatement(this, resultSetCache, statement, sql) : statement;
	}
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
		...
		return resultSetCache != null && resultSetCache.acceptQuery(sql) ?
